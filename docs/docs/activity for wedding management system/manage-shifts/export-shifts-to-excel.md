# Activity Export Shifts to Excel
...
|Sys|
:(4) Display filtered shifts list;

|S|
:(5) Click "Export Excel" button;

|Sys|
:(6) Query shifts data with current filter;
...
|Sys|
:(7) Generate Excel file with shifts data;
...
<!-- diagram id="activity-manage-shifts-export-shifts-to-excel" -->
